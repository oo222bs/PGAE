...
def main():
    ...
    for input in train_dataloader:
        ...
        if sentence_idx == 0:
            ...
            L_bw_feed = L_bw_before[35:40, :, :]
        elif sentence_idx == 1:
            L_fw_feed = L_fw_before[5:10, :, :]
            L_bw_feed = L_bw_before[30:35, :, :]
        elif sentence_idx == 2:
            L_fw_feed = L_fw_before[10:15, :, :]
            L_bw_feed = L_bw_before[25:30, :, :]
        elif sentence_idx == 3:
            L_fw_feed = L_fw_before[15:20, :, :]
            L_bw_feed = L_bw_before[20:25, :, :]
        elif sentence_idx == 4:
            L_fw_feed = L_fw_before[20:25, :, :]
            L_bw_feed = L_bw_before[15:20, :, :]
        elif sentence_idx == 5:
            L_fw_feed = L_fw_before[25:30, :, :]
            L_bw_feed = L_bw_before[10:15, :, :]
        elif sentence_idx == 6:
            L_fw_feed = L_fw_before[30:35, :, :]
            L_bw_feed = L_bw_before[5:10, :, :]
        else:
            L_fw_feed = L_fw_before[35:40, :, :]
            L_bw_feed = L_bw_before[0:5, :, :]
